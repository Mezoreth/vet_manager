...
export default function BasicButtons({variant='contained', handleNewClick=()=> {} }) {
    return (
      <ButtonGroup variant={variant} aria-label="Basic button group" fullWidth sx={{ height:'100%' , alignItems:'center', alignContent:'center', border:0, bgcolor: (theme) => theme.palette.background.default }}>
        ...
        <Button color= 'info' startIcon={<EditIcon />} >Editar</Button>
        <Button color= 'error' startIcon={<DeleteIcon />} >Eliminar</Button>
      </ButtonGroup>
    );
  }