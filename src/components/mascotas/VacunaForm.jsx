...
export default function VacunaForm({ open, onClose }) {
    const [vacuna, setVacuna] = useState('')
    const [fdosis, setFdosis] = useState()
    const [frefuerzo, setFrefuerzo] = useState()

    //inicializar la fecha de refuerzo 15 dias despues de la fecha de inicio
          ...
          <Typography variant="h6" component="div" sx={{ marginBottom: 2 , textAlign: 'left', color: 'primary.main'}}>
            ...
            <Stack spacing={2} direction="row" sx={{marginBottom: 4 }}>
                    <TextField
                        ...
                        variant='outlined'
                        label="Vacuna"
                        onChange={e => setVacuna(e.target.value.toUpperCase())}
                        value={vacuna}
                        fullWidth
                        required
                    />
